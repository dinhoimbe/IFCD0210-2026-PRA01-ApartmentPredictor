...
Este proyecto corresponde al ejercicio **PRA01**, cuyo objetivo es el desarrollo de una **aplicación web SPA** utilizando **React y Vite** como frontend del sistema _ApartmentPredictor_.  
...
El proyecto **PRA01**, demostrando la capacidad de diseñar, implementar y documentar una SPA moderna con React y Vite, siguiendo buenas prácticas y los objetivos formativos del IFCD0210.
